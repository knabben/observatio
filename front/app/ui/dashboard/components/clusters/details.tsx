      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Grid>
          <GridCol span={6}>
            ...
            <Table
              className={sourceCodePro400.className}
              ...
              <Table.Tbody className="text-base">
                {
                  cluster.conditions?.map((condition) => (
                    <Table.Tr>
                      ...
                      <Table.Td><Pill size="md">{condition.status}</Pill></Table.Td>
          ...
          { cluster.clusterClass.isClusterClass ?
            <>
              ...
              >
                <Table.Tbody className="text-base">
                  <Table.Tr>
                    <Table.Th className="text-medium" w={200}>Kubernetes Version</Table.Th>
